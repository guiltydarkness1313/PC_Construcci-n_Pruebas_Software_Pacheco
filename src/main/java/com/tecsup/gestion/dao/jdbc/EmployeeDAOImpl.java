...
public class EmployeeDAOImpl implements EmployeeDAO {
	...
	public Employee findEmployee(int employee_id) throws DAOException, EmptyResultException {
		...
		String query = "SELECT employee_id, age,login, password, first_name, last_name, salary, department_id "
	...
	public List<Employee> findAllEmployees() throws DAOException, EmptyResultException {
		...
		String query = "SELECT employee_id,age, login, password, first_name, last_name, salary, department_id FROM employees ";
	...
	@Override
	public Employee findEmployeebyNameLastNameAge(String name, String lastname, int age)
			throws DAOException, EmptyResultException {
		
		String query="SELECT employee_id, login, password, age,first_name, last_name, salary, department_id \r\n" + 
				"FROM employees WHERE (upper(first_name) like upper(?)) AND (upper(last_name) like upper(?)) AND age = ?;";
		Object[] params=new Object[] {name,lastname,age};
		try {
			Employee emp=(Employee)jdbcTemplate.queryForObject(query, params,new EmployeeMapper());
			return emp;
		}catch(EmptyResultDataAccessException e) {
	...
	public Employee validate(String login, String pwd) throws LoginException, DAOException {
		...
		String query = "SELECT login, password,age, employee_id, first_name, last_name, salary, department_id  "
