...
public class EmployeeDAOTest {
	...
	@Test
	public void testfindEmployeebyNameLastNameAge() {
		try {
			Employee emp=employeeDAO.findEmployeebyNameLastNameAge("Paul", "Pacheco", 20);
			Assert.assertNotNull(emp);
			
			Assert.assertEquals("pacheco", emp.getLogin());
			Assert.assertEquals("123456", emp.getPassword());
			Assert.assertEquals("Paul", emp.getFirstname());
			Assert.assertEquals("Pacheco", emp.getLastname());
			Assert.assertEquals(3100, emp.getSalary());
